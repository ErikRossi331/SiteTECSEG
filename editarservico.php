...
if (empty($codigo)) {
    $_SESSION['msg'] = "<p style='color: #f00;'>Erro: Serviço não encontrado!</p>";
    header("Location: editarservico.php");
    exit();
}

$query_usuario = "SELECT * FROM servico WHERE codigo = $codigo LIMIT 1";
...
<div class="container theme-showcase" role="main">
            <div class="page-header">
                ...
                <br>
                <font color="white">
                <font size=6><b>Informações do Serviço </font></b>
                <br><br>
                <?php
echo '<img src="./imagens_servico/'.$row_usuario['codigo'].'/'.$row_usuario['imagem'].'" class="image12"/>';
?>
                <div class="username">
                </div>
                ...
                <div class="borda"></div>
            <br>
            <font size=4><b>Editar Serviço </font></b>
            <br>
            <br>
...
if (!$empty_input) {
    ...
    $nome_imgpqn = $_FILES['imgpqn']['name'];
                ...
                $query_up_usuario= "UPDATE servico SET nome=:nome, precodesc=:precodesc, precovenda=:precovenda, 
                info=:info, imagem=:imagem, imgprincipal=:imgprincipal, imgpqn1=:imgpqn1, imgpqn2=:imgpqn2, imgpqn=:imgpqn, descricao=:descricao, nometec=:nometec
                WHERE codigo=:codigo";
        ...
        $diretorio = 'imagens_servico/' . $codigo.'/';
        ...
        move_uploaded_file($_FILES['imgpqn']['tmp_name'], $diretorio.$nome_imgpqn)){
                    $_SESSION['skil2'] = "<script>alert('Serviço editado com sucesso')</script>";
                    header("Location: admin.php");
}
...
#descricao {
    ...
    width: 500px;
      ...
      <label for="disabledTextInput" class="form-label">Nome:</label>
            ...
            <label for="disabledTextInput" class="form-label">Preço original do serviço em caso de desconto:<br>
                <font color="gray" size="2">(Caso o serviço não tenha desconto de preço, deixe nulo)</font>
            </label>
...
<label for="disabledTextInput" class="form-label">Preço de Venda:</label>
            ...
            <label for="disabledTextInput" class="form-label">Descrição do Serviço: <font color="gray" size="2">(Página de vendas)</font></label>
...
<label for="disabledTextInput" class="form-label">Nome Técnico do Serviço: <font color="gray" size="2">(Título na página de vendas)</font></label>
  ...
  <label for="imagem" class="form-label">Foto do Serviço: <font color="gray" size="2"> (Vitrine)</font></label>
 <input type="file" name="imagem" id="imagem" class="form-control" value="<?php
            ...
            ?>"><br>
            <label for="imgprincipal" class="form-label">Foto do Serviço: <font color="gray" size="2"> (Imagem primária de venda)</font></label>
 <input type="file" name="imgprincipal" id="imagem" class="form-control" value="<?php
            ...
            ?>"><br>
              ...
              <label for="imagem" class="form-label">Foto do Serviço: <font color="gray" size="2"> (Imagem pequena 1)</font></label>
 <input type="file" name="imgpqn1" id="imagem" class="form-control" value="<?php
            ...
            ?>" ><br>
                          ...
                          <label for="imagem" class="form-label">Foto do Serviço: <font color="gray" size="2"> (Imagem pequena 2)</font></label>
 <input type="file" name="imgpqn2" id="imagem" class="form-control" value="<?php
            ...
            ?>" ><br>
                          ...
                          <label for="imagem" class="form-label">Foto do Serviço: <font color="gray" size="2"> (Imagem pequena 3)</font></label>
