...
<head>
  <title> TecSeg | Cadastrar Produtos </title>
...
<a class="align3" href="#" onclick="myFunction2()"><img class="usuario" src="admin.png" height="50px" width="50px"></a>
 ...
 <?php } ?>
  ...
  <a class="active" onclick="myFunction()" href="#">Cadastrar Produtos ⠀<i class="arrow down"></i></a>
...
<center>
<b><font size="6" color="lightgray">Cadastrar Produtos</font></b>
<br>
<?php
...
<br>
 ...
 <form method="POST" enctype="multipart/form-data" action="proc_cad_img.php">
            <div class="mb-3">
      <label for="disabledTextInput" class="form-label">Nome:</label>
             ...
             <label for="disabledTextInput" class="form-label">Preço de Custo:</label>
                       ...
                       <input type="text" name="precocusto" id="precocusto" class="form-control"><br>
...
<label for="disabledTextInput" class="form-label">Preço de Venda:</label>
            ...
            <label for="disabledTextInput" class="form-label">Quantidade no estoque:</label> <input type="text" name="qtd" id="qtd" class="form-control"><br>
