...
<head>
	<meta charset="utf-8">
	<title> Serviço - Formatação/Reinstalação de Windows/Linux para Computadores ou Notebooks. </title>
...
<div id="carouselExampleDark" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-indicators">
    <button type="button" data-bs-target="#carouselExampleDark" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1">
      <div class="imgpqn1">
      <img src=".\formatacao img\sistema1.jpg" height="150px" width="150px"></div></button>
    </button>
    <button type="button" data-bs-target="#carouselExampleDark" data-bs-slide-to="1" aria-label="Slide 2">
      <div class="imgpqn2">
      <img src=".\formatacao img\sistema2.jpg" height="150px" width="150px"></div></button>
  

  </div>
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="99999999">
      <a href=".\formatacao img\sistema1.jpg">
      <img src=".\formatacao img\sistema1.jpg" class="imj" alt="..."></a>
      <div class="carousel-caption d-none d-md-block">
      </div>
    </div>
    <div class="carousel-item" data-bs-interval="99999999">
      <a href=".\formatacao img\sistema2.jpg">
      <img src=".\formatacao img\sistema2.jpg" class="imj" alt="..."></a>
      <div class="carousel-caption d-none d-md-block">
      </div>
    </div>
  </div>
...
<h7>
SERVIÇO - FORMATAÇÃO/REINSTALAÇÃO DE WINDOWS/LINUX PARA COMPUTADORES OU NOTEBOOKS
</h7>
<br><br>
<h8> <font color="6B6B6E"><s>R$ 120,00</s></h8>
  <h9> <b><font color="white">R$ 78,00</b></h9>
    <h12> 35% OFF </h12>
    <h13> <font color="lightgrey"> Ou em até</font><b><font color="#0992ed" size="4"> 3x</font> <font color="#0992ed">de<font color="#0992ed" size="4"> R$26,00</font> sem juros. </h13></b></font>
  ...
  <script type="text/javascript">
    ...
    <a href="checkout-form2.php?codigo=<?php echo 6; ?>">
    <button type="button" class="btn btn-primary btn-lg">Comprar Agora</button></a>
    <a href="carrinho2.php?acao=add&codigo=<?php echo 6; ?>" class="card-link">
...
input.addEventListener("keyup", function(event) {
  if (event.keyCode === 13) {
   ...
   document.getElementById("btnfrete").click();
        ...
        ⠀🔧<font color="#0992ed"><u>Serviço de Manutenção.</u></font> Um dos nossos profissionais será  ⠀⠀enviado para realizar o serviço, ou você pode se apresentar em  ⠀⠀uma das nossas centrais de atendimento presencialmente. </h17></</div>
...
<br>
<h17>⠀⠀⠀Além da formatação também está incluso o backup de todos os arquivos, limpeza interna (caso seja necessário), instalação de todos os drivers necessários para o funcionamento correto do computador e vários programas como  ⠀⠀⠀Microsoft Office, Google Chrome, Antivirus, entre outros. O cliente também tem a opção de escolher entre os sistemas operacionais Windows ou Linux sem nenhum custo adicional.
...
<br><br>
<h17>⠀⠀⠀<B>Serviço: </B><br>
⠀⠀⠀Formatação / Reinstalação de Sistema Operacional Windows e Linux com Backup
<br><br>
<B>⠀⠀⠀Tempo de atendimento:</B><br>
 ⠀⠀⠀12 a 24 horas com agendamento feito após a confirmação do pagamento da compra.
<br><br>
