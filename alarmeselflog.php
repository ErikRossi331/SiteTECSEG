...
<head>
  <meta charset="utf-8">
  <title> Serviço - Alarme Residencial Com Monitoramento Em Dispositivo Móvel </title>
...
<div id="carouselExampleDark" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-indicators">
    <button type="button" data-bs-target="#carouselExampleDark" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1">
      <div class="imgpqn1">
      <img src=".\alarme img\sistema1.jpg" height="150px" width="150px"></div></button>
    </button>
    <button type="button" data-bs-target="#carouselExampleDark" data-bs-slide-to="1" aria-label="Slide 2">
      <div class="imgpqn2">
      <img src=".\alarme img\sistema2.jpg" height="150px" width="150px"></div></button>
  

  </div>
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="99999999">
      <a href=".\alarme img\sistema1.jpg">
      <img src=".\alarme img\sistema1.jpg" class="imj" alt="..."></a>
      <div class="carousel-caption d-none d-md-block">
      </div>
    </div>
    <div class="carousel-item" data-bs-interval="99999999">
      <a href=".\alarme img\sistema2.jpg">
      <img src=".\alarme img\sistema2.jpg" class="imj" alt="..."></a>
      <div class="carousel-caption d-none d-md-block">
      </div>
    </div>
  </div>
...
<h7>
SERVIÇO - ALARME RESIDENCIAL COM MONITORAMENTO EM DISPOSITIVO MÓVEL
</h7>
<br><br>

  <h9> <b><font color="#0992ed">A partir de</font> <font color="white"> R$ 1.998,99</font></b></h9>
  ...
  <script type="text/javascript">
    ...
    <a href="checkout-form2.php?codigo=<?php echo 8; ?>">
    <button type="button" class="btn btn-primary btn-lg">Comprar Agora</button></a>
        <a href="carrinho2.php?acao=add&codigo=<?php echo 8; ?>" class="card-link">
...
<br>
<h17>⠀⠀⠀Apresentamos o KIT de alarme JFL com central de alarme Brisa Cell 804 de até 08 Zonas, sensor de abertura SHC-Fit para portas<br> ⠀⠀⠀e janelas e sensor de presença IDX 1001. Também estão inclusos nesse KIT a bateria para Centrais de Alarme, Sirene, Controle TX-4R 4.0.
<br>⠀⠀⠀Esse KIT é ideal para quem busca um monitoramento eficaz de alta qualidade, e pode ser instalado em residências e empresas. 
...
<br><br>
<h17>⠀⠀⠀<B>Serviço: </B><br>
⠀⠀⠀Alarme Residencial Com Monitoramento Em Dispositivo Móvel.
<br><br>
