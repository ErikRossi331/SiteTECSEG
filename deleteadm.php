...
<head>
  <title> TecSeg | Remover Administrador </title>
...
//Receber o número da página
        ...
        $query_produto = "SELECT * FROM admins where cod_adm <> 17 ORDER BY cod_adm  asc LIMIT $inicio, $limite_resultado";
...
echo "</center>";
                  ...
                  echo "<center><font color='white'> <br>";
                echo "<b>Nome de Usuário:</b>  $nome <br>";
                  echo "<b>Email:</b>  $email <br></font>";
                echo "<img src='admin.png'><br>";

                
                  echo "<a href='confirmarapagaadm.php?codigo=$cod_adm'><button class='btn btn-danger btn-mol'>Remover</button></a>";
                echo "<hr>";
            }

            //Contar a quantidade de registros no BD
            $query_qnt_registros = "SELECT COUNT(cod_adm) AS num_result FROM admins";
            ...
            echo "<font color = 'red'><center>Nenhum administrador encontrado.</font></center>";
        }
        ?>
<br><br>
