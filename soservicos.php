...
<?php include_once("conexaoprodutos.php");
$result_cursos = "SELECT * FROM servico";
...
<div class="topnav">
  ...
  <a class="active" onclick="myFunction()" href="#">Serviços ⠀<i class="arrow down"></i></a>
  <div id="myDropdown" class="dropdown-content">
  
        <a href="soprodutos.php" class="activeee">Produtos⠀</a><br>
          <a href="solucoes.php" class="activeee">⠀Início⠀⠀</a>
 </div>
...
input.addEventListener("keyup", function(event) {
  ...
  <h4><b><font color="white" face="Arial" size="6px">Veja todos os Nossos Serviços!</font></b></h4>
  <b><hr></b>
