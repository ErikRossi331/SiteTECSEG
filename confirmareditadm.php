...
if (empty($cod_adm)) {
    ...
    header("Location: confirmareditadm.php");
    exit();
}

$query_usuario = "SELECT * FROM admins WHERE cod_adm = $cod_adm";
...
<div class="container theme-showcase" role="main">
        ...
        if (!empty($dados['EditUsuario'])) {
            ...
            if (!$empty_input) {
                $query_up_usuario= "UPDATE admins SET nome=:nome, email=:email, senha=:senha
                ...
                $edit_usuario->bindParam(':cod_adm', $cod_adm, PDO::PARAM_INT);
                if($edit_usuario->execute()){
                    $_SESSION['msg16'] = "<script>alert('Perfil alterado com sucesso!');</script>";
...
<label for="disabledTextInput" class="form-label">Senha:</label>
            ...
            <input type="submit" class="btn btn-primary" value="Confirmar Alterações" name="EditUsuario">
                ...
                <a href="admin.php?id_curso=<?php echo $cod_adm; ?>">
