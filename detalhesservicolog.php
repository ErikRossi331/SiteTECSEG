...
$result_cursos = "SELECT * FROM servico WHERE codigo='$id_curso'";
...
$result_cursos2 = "SELECT * FROM servico where codigo <> '$id_curso'";
...
<div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
  <div class="carousel-indicators">
    <button type="button" data-bs-target="#carouselExampleDark" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1">
      <div class="imgpqn1">
      <?php
                echo '<img src="./imagens_servico/'.$row_cursos['codigo'].'/'.$row_cursos['imgprincipal'].'"height="150px" width="150px "/>';
                ?></div></button>
    </button>
    <button type="button" data-bs-target="#carouselExampleDark" data-bs-slide-to="1" aria-label="Slide 2">
      <div class="imgpqn2">
        <?php
      echo '<img src="./imagens_servico/'.$row_cursos['codigo'].'/'.$row_cursos['imgpqn1'].'"height="150px" width="150px "/>';
                ?></div></button>
    <button type="button" data-bs-target="#carouselExampleDark" data-bs-slide-to="2" aria-label="Slide 3">
       <div class="imgpqn3">
      <?php
      echo '<img src="./imagens_servico/'.$row_cursos['codigo'].'/'.$row_cursos['imgpqn2'].'"height="150px" width="150px "/>';
                ?></div></button>
    </button>
     <button type="button" data-bs-target="#carouselExampleDark" data-bs-slide-to="3" aria-label="Slide 4">
       <div class="imgpqn4">
      <?php
      echo '<img src="./imagens_servico/'.$row_cursos['codigo'].'/'.$row_cursos['imgpqn'].'"height="150px" width="150px "/>';
                ?></div></button>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="99999999">
     <?php
      echo '<img src="./imagens_servico/'.$row_cursos['codigo'].'/'.$row_cursos['imgprincipal'].'" class="imj"/>';
                ?>
    ...
    <div class="carousel-item" data-bs-interval="99999999">
      <?php
      echo '<img src="./imagens_servico/'.$row_cursos['codigo'].'/'.$row_cursos['imgpqn1'].'" class="imj"/>';
      ?>
      <div class="carousel-caption d-none d-md-block">
    ...
    <div class="carousel-item" data-bs-interval="99999999">
      <?php
      echo '<img src="./imagens_servico/'.$row_cursos['codigo'].'/'.$row_cursos['imgpqn2'].'" class="imj"/>';
      ?>
      <div class="carousel-caption d-none d-md-block">
     ...
     <div class="carousel-item" data-bs-interval="99999999">
      <?php
      echo '<img src="./imagens_servico/'.$row_cursos['codigo'].'/'.$row_cursos['imgpqn'].'" class="imj"/>';
      ?>
      <div class="carousel-caption d-none d-md-block">
         </div>
         </div>
...
<h8> <font color="6B6B6E"><s><?php echo $row_cursos['precodesc']; ?></s></h8>
  <h9> <b><font color="white"><?php echo '<font color= "#0992ed"> A partir de </font> R$ ' . $row_cursos['precovenda']; ?></b></h9>
  ...
  <a href="checkout-form2.php?codigo=<?php echo $id_curso; ?>">
    <button type="button" class="btn btn-primary btn-lg">Comprar Agora</button></a>
    <a href="carrinho2.php?acao=add&codigo=<?php echo $row_cursos['codigo']; ?>" class="card-link">
...
<div class="barrra2">
  ...
  <h4><b><font color="white" face="Arial" size="6px">Outros Serviços disponíveis</font></b></h4>
  <b><hr></b>
      ...
      <div class="row">
        <?php while($rows_cursos = mysqli_fetch_assoc($resultado_cursos2)){ ?>
          <div class="col-sm-6 col-md-4">
            <div class="thumbnail">
              <a href="detalhesservicolog.php?id_curso=<?php echo $rows_cursos['codigo']; ?>">
       <?php
