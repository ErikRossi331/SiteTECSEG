      ...
      <div class="row">
        <?php while($row_msg_cont = $resultado_msg_cont->fetch(PDO::FETCH_ASSOC)){ ?>
          <div class="col-sm-6 col-md-4">
            ...
            <div class="thumbnail">
              <a href="detalhesprodutoadm.php?id_curso=<?php echo $row_msg_cont['codigo']; ?>">
                <?php
              ...
              <div class="caption text-center">
                ...
                <?php  ?><h3><a href="confirmarapagaproduto.php?codigo=<?php echo $row_msg_cont['codigo']; ?>"> </h3>
                <?php  ?><h3> <button type="button" class="btn btn-danger">Remover</button></a> </h3>
              </div>
            </div>
          </div>
        <?php }
...
<br>
      ...
      <div class="row">
        <?php while($row_msg_cont2 = $resultado_msg_cont2->fetch(PDO::FETCH_ASSOC)){ ?>
          <div class="col-sm-6 col-md-4">
            <div class="thumbnail">
              <a href="detalhesservicoadm.php?id_curso=<?php echo $row_msg_cont2['codigo']; ?>">
                <?php
              ...
              <div class="caption text-center">
                ...
                <?php  ?><h3><?php echo "<b><font size=5 color='#0992ed'> R$ "  .  $row_msg_cont2['precovenda'] . "</font></b>"; ?>
                <?php  ?><h3><a href="confirmarapagaservico.php?codigo=<?php echo $row_msg_cont2['codigo']; ?>"></h3>
                <?php  ?><h3> <button type="button" class="btn btn-danger">Remover</button></a> </h3>
