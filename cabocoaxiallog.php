...
<head>
	<meta charset="utf-8">
	<title>Cabo Cftv Intelbras 4mm + 2px26 Awg 67%malha 100mts Fast Cam Fc67cbr</title>
...
<div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
  <div class="carousel-indicators">
    <button type="button" data-bs-target="#carouselExampleDark" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1">
      <div class="imgpqn1">
      <img src=".\cabo img\sistema1.jpg" height="150px" width="150px"></div></button>
    </button>
    <button type="button" data-bs-target="#carouselExampleDark" data-bs-slide-to="1" aria-label="Slide 2">
      <div class="imgpqn2">
      <img src=".\cabo img\sistema3.jpg" height="150px" width="150px"></div></button>
    <button type="button" data-bs-target="#carouselExampleDark" data-bs-slide-to="2" aria-label="Slide 3">
       <div class="imgpqn3">
      <img src=".\cabo img\sistema2.jpg" height="150px" width="150px"></div></button>
    </button>
     <button type="button" data-bs-target="#carouselExampleDark" data-bs-slide-to="3" aria-label="Slide 4">
       <div class="imgpqn4">
      <img src=".\cabo img\sistema4.jpg" height="150px" width="150px"></div></button>
      

  </div>
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="99999999">
      <a href=".\cabo img\sistema1.jpg">
      <img src=".\cabo img\sistema1.jpg" class="imj" alt="..."></a>
      <div class="carousel-caption d-none d-md-block">
      </div>
    </div>
    <div class="carousel-item" data-bs-interval="99999999">
      <a href=".\cabo img\sistema3.jpg">
      <img src=".\cabo img\sistema3.jpg" class="imj" alt="..."></a>
      <div class="carousel-caption d-none d-md-block">
        
      </div>
    </div>
    <div class="carousel-item" data-bs-interval="99999999">
      <a href=".\cabo img\sistema2.jpg">
      <img src="./cabo img/sistema2.jpg" class="imj" alt="..."></a>
      <div class="carousel-caption d-none d-md-block">
        
      </div>
    </div>
     <div class="carousel-item" data-bs-interval="99999999">
      <a href=".\cabo img\sistema4.jpg">
      <img src="./cabo img/sistema4.jpg" class="imj" alt="..."></a>
      <div class="carousel-caption d-none d-md-block">
         </div>
         </div>
  </div>
...
<h7>
CABO CFTV INTELBRAS 4mm + <br>2px26 AWG 67%MALHA 100MTS<br> FAST CAM FC67CBR
</h7>
<br><br>
  <h9> <b><font color="white">R$ 140,51</b></h9>
    <h13> <font color="lightgrey"> Ou em até</font><b><font color="#0992ed" size="4"> 3x</font> <font color="#0992ed">de<font color="#0992ed" size="4"> R$46,83</font> sem juros. </h13></b></font>

    <h10> ⠀Novo ⠀|⠀ 52 vendidos </h10>
  ...
  <script type="text/javascript">
    ...
    <h14> (63 disponíveis) </h14>
<a href="checkout-form.php?codigo=<?php echo 4; ?>">
    <button type="button" class="btn btn-primary btn-lg">Comprar Agora</button></a>
        <a href="carrinho.php?acao=add&codigo=<?php echo 4; ?>" class="card-link">
...
<br>
<h17>⠀⠀⠀Condutor central e pares de alimentação 100% cobre. O condutor interno em fios de cobre garante a integridade do sinal na transmissão de imagem das câmeras para os gravadores de vídeo. Sistema mais seguro e confiável<br>⠀⠀⠀Possui capa de isolação externa em PVC 70 °C que garante maior proteção e segurança. Custo-benefícioProdutos desenvolvidos para projetos de baixa e alta complexidade, atendendo desde residências, até grandes ⠀⠀⠀empreendimentos.
...
<br><br>
<h17>⠀⠀<b>Principais Características</b> <br>
  ⠀⠀» Desenvolvido para as necessidades dos projetos de CFTV;<br>
  ⠀⠀» Maior blindagem contra interferências eletromagnéticas;<br>
  ⠀⠀» Maior distância de transmissão de vídeo;<br>
  ⠀⠀» 2 vias de alimentação cobre 26 AWG;<br>
  ⠀⠀» Impedância 75 Ohms;<br>
  ⠀⠀» Capa isolante em PVC;<br>
  ⠀⠀» Blindado;<br>
  ⠀⠀» Uso interno.<br>
<br>
...
<br>
   ⠀⠀<b>Aplicação:</b> <br>
   ⠀⠀Redes de CFTV analógico<br>
<br>
   ⠀⠀<b>Isolamento dos condutores bipolares:</b><br> 
   ⠀⠀<b>PVCD elétrico do condutor central:</b> <br>
   ⠀⠀Polietileno expandido a gás, com diâmetro de Ø 2,30mm ± 0,10mm<br>
<br>
   ⠀⠀<b>Blindagem / malha:</b> <br>
   ⠀⠀67% de cobertura (48 x Ø 0,127mm fios flexíveis de liga de cobre)<br>
<br>
   ⠀⠀<b>Condutores bipolares:</b> <br>
   ⠀⠀Filamentos flexíveis de cobre 6 x Ø 0,145mmCada <br>
<br>
   ⠀⠀<b>Condutor: <br></b>
      ⠀⠀Ø 0,80mm ± 0,015mm<br>
<br>
  ⠀⠀ <b>Condutor central: <br></b>
   ⠀⠀Filamentos flexíveis de cobre 6 x Ø 0,145mm ± 0,015mmCapa PVC com diâmetro de 3,8mm ± 0,20mm x 6,80 ± 0,20mm
<br><br>
   ⠀⠀  <b> Garantia do Fornecedor<br></b>
