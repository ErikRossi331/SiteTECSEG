<?php 
	session_start();
	ob_start();
	require_once "functions/product2.php";
	require_once "functions/cart2.php";
...
window.onclick = function(event) {
  if (!event.target.matches('.align3')) {
	...
	<div class="container">
		<div class="card mt-5">
			 <div class="card-body">
	    		<h4 class="card-title">Meu Carrinho de Serviços</h4>
	    		<a class="btn btn-info" href="solucoeslogado.php">Voltar</a>
	    		<a href="carrinho.php" class="btn btn-warning">Carrinho de Produtos</a>
	    		
	    	</div>
		</div>

		<?php if($resultsCarts) : ?>
			<form action="carrinho2.php?acao=up" method="post">
				...
				<tbody>
				  <?php foreach($resultsCarts as $result) : ?>
					<tr>
						...
						<td><a href="carrinho2.php?acao=del&codigo=<?php echo $result['id']?>" class="btn btn-danger">Remover</a></td>
