        ...
        if(isset($_SESSION['msg21'])){
         ...
         if(isset($_SESSION['msg28'])){
            ...
            unset($_SESSION['msg28']);
               ...
               if(isset($_SESSION['msg29'])){
            echo $_SESSION['msg29'];
            unset($_SESSION['msg29']);
        }
...
<a class="align3" href="#" onclick="myFunction2()"><img class="usuario" src="admin.png" height="50px" width="50px"></a>
 ...
 <?php } ?>
  ...
  <a class="active" onclick="myFunction()" href="#">Deletar ⠀<i class="arrow down"></i></a>
...
<div class="container-fluid">
    <form class="d-flex" method="post" action="procpesquisaadmdel.php">
...
<br><br>
<h4><b><font color="white" face="Arial" size="6px">Visualizar e Remover Produtos</font></b></h4>
  <b><hr></b>
...
<div class="container theme-showcase" role="main">
    ...
    <br>
    <a href="confirmarapagaproduto.php?codigo=<?php echo $rows_cursos['codigo']; ?>">
   ...
   ⠀  
    ...
    <br><br>
<h4><b><font color="white" face="Arial" size="6px">Visualizar e Remover Serviços</font></b></h4>
  <b><hr></b>
      ...
      <div class="row">
        ...
        <?php
              ...
              <div class="caption text-center">
                ...
                <?php  ?><h3><?php echo "<b><font size=5 color='#0992ed'> R$ "  .  $rows_cursos['precovenda'] . "</font></b>"; ?></h3></a>
    <br>
    <a href="confirmarapagaservico.php?codigo=<?php echo $rows_cursos['codigo']; ?>">
            <button type="button" class="btn btn-danger">Remover</button> 
            <br>
