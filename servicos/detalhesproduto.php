...
<div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
  <div class="carousel-indicators">
    <button type="button" data-bs-target="#carouselExampleDark" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1">
      <div class="imgpqn1">
      <?php echo '<img src="data:image/jpeg;base64,'.base64_encode($row_cursos['imgprincipal']).'" height="150px" width="150px"/>';?></div></button>
    </button>
    <button type="button" data-bs-target="#carouselExampleDark" data-bs-slide-to="1" aria-label="Slide 2">
      <div class="imgpqn2">
      <?php echo '<img src="data:image/jpeg;base64,'.base64_encode($row_cursos['imgpqn1']).'" height="150px" width="150px"/>';?></div></button>
    <button type="button" data-bs-target="#carouselExampleDark" data-bs-slide-to="2" aria-label="Slide 3">
       <div class="imgpqn3">
      <?php echo '<img src="data:image/jpeg;base64,'.base64_encode($row_cursos['imgpqn2']).'" height="150px" width="150px"/>';?></div></button>
    </button>
     <button type="button" data-bs-target="#carouselExampleDark" data-bs-slide-to="3" aria-label="Slide 4">
       <div class="imgpqn4">
      <?php echo '<img src="data:image/jpeg;base64,'.base64_encode($row_cursos['imgpqn']).'" height="150px" width="150px"/>';?></div></button>

  </div>
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="99999999">
      <?php echo '<img src="data:image/jpeg;base64,'.base64_encode($row_cursos['imgprincipal']).'" class="imj"/>';?>
      <div class="carousel-caption d-none d-md-block">
      </div>
    </div>
    <div class="carousel-item" data-bs-interval="99999999">
      <?php echo '<img src="data:image/jpeg;base64,'.base64_encode($row_cursos['imgpqn1']).'" class="imj"/>';?>
      <div class="carousel-caption d-none d-md-block">
        
      </div>
    </div>
    <div class="carousel-item" data-bs-interval="99999999">
      <?php echo '<img src="data:image/jpeg;base64,'.base64_encode($row_cursos['imgpqn2']).'" class="imj"/>';?>
      <div class="carousel-caption d-none d-md-block">
        
      </div>
    </div>
     <div class="carousel-item" data-bs-interval="99999999">
      <?php echo '<img src="data:image/jpeg;base64,'.base64_encode($row_cursos['imgpqn']).'" class="imj"/>';?>
      <div class="carousel-caption d-none d-md-block">
         </div>
         </div>
  </div>
...
<br><br>
<h8> <font color="6B6B6E"><s><?php echo 'R$ ' . $row_cursos['precodesc']; ?></s></h8>
...
<div class="container theme-showcase" role="main">
      ...
      <div class="row">
        ...
        <?php echo '<img src="data:image/jpeg;base64,'.base64_encode($rows_cursos['imagem']).'" class="image12"/>';?>
      </a>
