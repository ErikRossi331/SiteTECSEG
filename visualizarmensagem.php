...
<?php
$query_produto = "SELECT * FROM mensagem WHERE codigo = $codigo LIMIT 1";
        ...
        if (($result_produto) AND ($result_produto->rowCount() != 0)) {
            ...
            //echo "ID: " . $row_usuario['id'] . "<br>";            
              echo "<center><font color='white'><b></b><br>";
                echo "<b>Mensagem enviada:</b></center> <div class='linha'> $mensagem <br></font></div>";
                echo "<br>";
                                echo "<br>";
                echo "<center><font color='white'>Nome de Usuário do Remetente:<B> $nomeus</B></font>";
                                       echo "<center><font color='white'>Email do Remetente:<B> $emailus</B></font>";
                                                echo "<br>";
                                                                echo "<br>";
                                                                echo "<br>";

              echo "<center><a href='vermensagemadm.php'><button class='btn btn-secondary btn-mol'>Voltar</button></a></center>";
              echo "<center><a href='confapagarmensagem.php?codigo=$codigo'><button class='btn btn-danger'>Marcar como respondido</button></a></center>";

        } else {
            $_SESSION['msg'] = "<p style='color: #f00;'>Erro: Mensagem Não Encontrada!</p>";
            header("Location: visualizarmensagem.php");
        }
