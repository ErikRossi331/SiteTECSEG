    ...
    <body bgcolor="#333">
        ...
        <div class="container theme-showcase" role="main">
            <div class="page-header">
                ...
                <div class="username">
                <h1> Tem certeza que deseja deletar o administrador <b><?php echo $nome; ?>?<br></b>
                    Todas as suas permissões e dados cadastrados no website serão deletados para sempre.<br><br>
                    <a id="corr" href="apagaradm.php?cod_adm=<?php echo $cod_adm; ?>">
                    <button class="btn btn-danger">Deletar Administrador</button>
</a>
<a href="deleteadm.php">
