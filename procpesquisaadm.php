          ...
          <div class="col-sm-6 col-md-4">
            ...
            <div class="thumbnail">
              ...
              <div class="caption text-center">
                ...
                <?php  ?><h3><a href="editar.php?codigo=<?php echo $row_msg_cont['codigo'];?>"> </h3>
                <?php  ?><h3> <button type="button" class="btn btn-secondary">Editar</button></a> </h3>
              </div>
            </div>
          </div>
        <?php }
          ...
          <div class="col-sm-6 col-md-4">
            <div class="thumbnail">
              ...
              <div class="caption text-center">
                ...
                <?php  ?><h3><a href="editarservico.php?codigo=<?php echo $row_msg_cont2['codigo'];?>"> </h3>
                <?php  ?><h3> <button type="button" class="btn btn-secondary">Editar</button></a> </h3>
